            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="evn-thumb-wrap mb-45 p-relative">
                     <div class="evn-thumb">
                        <img src="assets/img/event/ebent-details-1.jpg" alt="">
                     </div>
            ...
            <div class="row">
               <div class="col-xl-8">
                  <div class="evn-text-box mb-30">
                     <h4 class="tp-inner-title">Event Overview</h4>
                     <p>Lorem ipsum is simply free text used by copytyping refreshing. Neque porro est qui dolorem ipsum quia quaed inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit amet finibus eros. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the ndustry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries. Lorem Ipsum is simply dummy text of the new design printng and type setting Ipsum Take a look at.</p>
                  </div>
                  <div class="evn-list-box">
                     <h4 class="tp-inner-title mb-20">Event Requirments</h4>
                     <ul>
                        <li>
                     ...
                     <a class="tp-btn-xl green-anim" href="event-details.html">REGISTER YOURSELF</a>
                  </div>
               </div>
               <div class="col-xl-4">
                  <div class="evn-sidebar">
                     <div class="evn-avatar-box d-flex align-items-center">
                        ...
                        <div class="evn-avatar-info">
                           <h4 class="evn-avatar-name">Kaira Beasley</h4>
                     ...
                     <div class="evn-user-wrap">
                        ...
                        <div class="evn-user-item d-flex align-items-start">
                           ...
                           <div class="evn-user-info">
                              <p>Phone:</p>
                              <span><a href="tel:+99456(9874)3456">+99 456 (9874) 3456</a></span>
                           </div>
                        </div>
                        <div class="evn-user-item d-flex align-items-start">
                           <div class="evn-user-icon">
                        ...
                        <div class="evn-user-item d-flex align-items-start">
                           ...
                           <div class="evn-user-info">
                              <p>Location:</p>
                              <span><a href="https://www.google.com/maps/@23.8223026,90.3842538,14z?entry=ttu" target="_blank">The Strand, sector USA</a></span>
                           </div>
                        </div>
                     </div>
                  </div>
