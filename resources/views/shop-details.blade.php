...
<body>
   ...
   <main>
      ...
      <div class="tp-shop-details-area pt-120 pb-120">
         <div class="container">
            <div class="tp-shop-details-top-wrap">
               <div class="row">
                  <div class="col-xl-6 col-lg-6">
                     <div class="tp-shop-details-wrapper">
                        <div class="tp-shop-details-tab-content-box mb-20">
                           <div class="tab-content" id="nav-tabContent">
                              <div class="tab-pane fade show active" id="nav-one" role="tabpanel"
                                 aria-labelledby="nav-one-tab">
                                 <div class="tp-shop-details-tab-big-img">
                                    <img src="assets/img/shop/shop-details-1.png" alt="">
                                 </div>
                              </div>
                              <div class="tab-pane fade" id="nav-two" role="tabpanel" aria-labelledby="nav-two-tab">
                                 <div class="tp-shop-details-tab-big-img">
                                    <img src="assets/img/shop/shop-details-3.png" alt="">
                                 </div>
                              </div>
                              <div class="tab-pane fade" id="nav-three" role="tabpanel" aria-labelledby="nav-three-tab">
                                 <div class="tp-shop-details-tab-big-img">
                                    <img src="assets/img/shop/shop-details-2.png" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="tp-shop-details-tab-btn-box">
                           <nav>
                              <div class="nav nav-tab justify-content-center" id="nav-tab" role="tablist">
                                 <button class="nav-links active" id="nav-one-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true">
                                    <img src="assets/img/shop/shop-details-sm-1.png" alt="">
                                 </button>
                                 <button class="nav-links" id="nav-two-tab" data-bs-toggle="tab" data-bs-target="#nav-two"
                                    ...
                                    <img src="assets/img/shop/shop-details-sm-2.png" alt="">
                                 </button>
                                 <button class="nav-links" id="nav-three-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">
                                    <img src="assets/img/shop/shop-details-sm-3.png" alt="">
                                 </button>
                              </div>
                           </nav>
                        </div>
                  ...
                  <div class="col-xl-6 col-lg-6">
                     <div class="tp-shop-details-right-wrap">
                        <div class="tp-shop-details-title-box">
                           <span class="tp-section-subtitle-2">Ancent Metal</span>
                           <h4 class="tp-section-title mb-30">The Gramophone</h4>
                           <div class="tp-shop-details-ratting">
                              <span>
                                 <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                              ...
                              <span class="review-text">(2 Customer reviews)</span>
                           </div>
                           <div class="tp-shop-details-price">
                              <span>$340.00</span>
                           </div>
                           <div class="tp-shop-details-text">
                              <p>At vero eos et accusamus et iusto dignissimos ducimus blanditiis
                                 praesentium voluptatum deleniti atque.At vero eos et accusamus et
                                 dignissimos ducimus blanditiis praesentium voluptatum deleniti.
                              </p>
                           </div>
                           <div class="tp-shop-details-quantity-wrap">
                              <div class="tp-shop-details-quantity-box d-flex align-items-center">
                                 <span>Quantity</span>
                                 <div class="tp-shop-details-quantity">
                                    <div class="tp-cart-minus"><i class="fal fa-minus"></i></div>
                                    <input type="text" value="1">
                                    <div class="tp-cart-plus"><i class="fal fa-plus"></i></div>
                                 </div>
                              </div>
                              <div class="tp-shop-details-btn w-100">
                                 <a class="tp-btn cart mr-20" href="cart.html">Add To Cart</a>
                                 <a class="tp-btn" href="cart.html">Add to Wishlist</a>
                              </div>
                              <div class="tp-shop-details-social">
                                 <span>Share:</span>
                                 <a href="#"><i class="fab fa-facebook-f"></i></a>
                                 <a href="#"><i class="fab fa-instagram"></i></a>
                                 <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="tp-shop-details-text-box">
                     <h4 class="tp-shop-details-title">Our Description</h4>
                     <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                        voluptatum deleniti atque corrupti quos dolores et <br> quas molestias excepturi sint
                        occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt
                        mollitia animi, id est laborum et <br> dolorum fuga. Et harum quidem rerum facilis est
                        et expedita distinctio.</p>
                     <p class="pb-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                        praesentium voluptatum deleniti atque corrupti quos dolores et <br> quas molestias
                        excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia
                        deserunt mollitia animi, id est laborum et <br>dolorum fuga similique sunt in culpa qui
                        officia deserunt</p>
                  </div>
               </div>
               <div class="col-xl-12">
                  <div class="postbox__comment mb-50">
                     <h3 class="postbox__comment-title">2 Reviews for Statex</h3>
                     <ul>
                        <li>
                              ...
                              <div class="postbox__comment-info d-flex align-items-center">
                                 ...
                                 <div class="postbox__comment-name p-relative">
                                    ...
                                    <div class="postbox__comment-text">
                                       <p>Curabitur luctus nisl in justo maximus egestas. Curabitur sit amet sapien vel nunc molestie pulvinar at vitae quam. Aliquam lobortis nisi vitae congue consectetur. Aliquam et quam non metus t vero eos et accusamus et iusto odio dignissimos ducimus qui At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium.</p>
                                       <div class="postbox__star">
               ...
               <div class="co-xl-12">
                  <div class="tp-team-details-contact-box grey-bg-2">
                     <h4 class="tp-team-details-title pb-20">Submit Your Review</h4>
                     <form action="#">
                           ...
                           <div class="row">
                              ...
                              <div class="col-xl-12">
                                 <div class="tp-contact-2-input p-relative">
                                    ...
                                    <span><i class="fa-light fa-arrow-up-right-from-square"></i></span>
                                 </div>
                              </div>
                              <div class="col-xl-12">
                                 <div class="tp-contact-2-input p-relative">
      ...
      <!-- project area start -->
      <div class="tp-project-area p-relative pb-120">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-xl-8">
                  <div class="tp-team-title-box mb-50 text-center">
                     <h4 class="tp-section-title mb-25">Related Products</h4>
                  </div>
               </div>
            </div>
            <div class="row">
                     ...
                     <div class="swiper-container tp-project-2-slider-active">
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="tp-shop-item text-center">
                                 <div class="tp-shop-thumb p-relative">
                                    <img src="assets/img/shop/shop-2.png" alt="">
                                    <a class="tp-btn-cart" href="#">ADD TO CART</a>
                                 </div>
                                 <div class="tp-shop-content">
                                    <h4 class="tp-shop-title"><a href="#">King Statue</a></h4>
                                    <span>$44</span>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-shop-item text-center">
                                 <div class="tp-shop-thumb p-relative">
                                    ...
                                    <a class="tp-btn-cart" href="#">ADD TO CART</a>
                                    <span class="tp-shop-badge">Sale!</span>
                                 </div>
                                 <div class="tp-shop-content">
                                    <h4 class="tp-shop-title"><a href="#">Classic Alarm</a></h4>
                                    <span><del>$18.00</del>  $16.00</span>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-shop-item text-center">
                                 ...
                                 <div class="tp-shop-content">
                                    <h4 class="tp-shop-title"><a href="#">Ancient Tanpura</a></h4>
                                    <span>$685.00</span>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-shop-item text-center">
                                 ...
                                 <div class="tp-shop-content">
                                    <h4 class="tp-shop-title"><a href="#">Black & White TV</a></h4>
                                    <span>$225.00</span>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-shop-item text-center">
                                 ...
                                 <div class="tp-shop-content">
                                    <h4 class="tp-shop-title"><a href="#">Wagon Van</a></h4>
                                    <span>$925.00</span>
                                 </div>
                              </div>
                           </div>
