            ...
            <div class="row">
               <div class="col-xl-4 col-lg-4">
                  <div class="tp-service-details-left-box">
                     ...
                     <div class="tp-service-details-widget mb-30">
                        <h4 class="tp-service-details-title">Get a Free Quote</h4>
               ...
               <div class="col-xl-8 col-lg-8">
                  <div class="tp-service-details-right-wrap">
                     ...
                     <div class="tp-service-details-right-text mb-30">
                        <h4 class="tp-service-details-right-title mb-15">Birth Certificate</h4>
                        <p>
                     ...
                     <div class="tp-service-details-right-quote-text">
                        <p>You must apply for a Business Schengen Visa at the consulate or embassy of the nation into which you will</p>
                     </div>
                     <div class="tp-service-details-right-feature-box pt-60 pb-20 d-flex justify-content-between align-items-center">
                        <div class="tp-service-details-right-feature mb-30 text-center">
                           <span><i class="flaticon-approved"></i></span>
                           <h4>Apply <br> City Job</h4>
                        </div>
                        <div class="tp-service-details-right-feature active mb-30 text-center">
                           <span><i class="flaticon-industrial-park"></i></span>
                           <h4>Bulding <br> Permission</h4>
                        </div>
                        <div class="tp-service-details-right-feature mb-30 text-center">
                           <span><i class="flaticon-gavel"></i></span>
                           <h4>Court & <br> Law Service</h4>
                        </div>
                     </div>
                     <div class="tp-service-details-right-feature-list mb-60">
                        <ul>
                           <li class="p-relative">
                              ...
                              <p class="mb-0">
                                 Neque porro est qui dolorem ipsum quia quaed inventore veritatis et quasi architecto
                                 beatae vitae dicta sunt explicabo lacus quis enim var sed efficitur turpi
                              </p>
                           </li>
                     ...
                     <div class="tp-service-details-right-accordion-wrapper">
                              ...
                              <div class="accordion-items">
                                 ...
                                 <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                       Already the people had fled from the city by millions at first the rich,
                                        in their private motor-cars and dirigibles, and then the great mass of the population
                                        ,on foot, carrying the plague
                                    </div>
                                 </div>
                              </div>
                              <div class="accordion-items">
