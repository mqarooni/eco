...
<body>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index text-center">
                     <h3 class="breadcrumb__title">Our History</h3>
      ...
      <!-- history area start -->
      <div class="tp-history-area pt-120 pb-20">
         <div class="container">
            <div class="row">
               <div class="col-xl-6">
                  <div class="tp-history-title-box mb-60">
                     <span class="tp-section-subtitle-2">Smart City History</span>
                     <h4 class="tp-section-title">Memorable city history</h4>
                  </div>
               </div>
            </div>
            <div class="row mb-100">
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="tp-history-right">
                     <div class="tp-history-content space-1">
                        <h4 class="tp-history-title">Founding City</h4>
                        <p>
            ...
            <div class="row mb-100 order-1 order-lg-0">
               <div class="col-xl-6 col-lg-6">
                  <div class="tp-history-right">
                     <div class="tp-history-content space-2 text-start text-lg-end">
                        <h4 class="tp-history-title">Clean City</h4>
                        <p>
                           There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised. Suspendisse sollicitudin velit sed leo. Ut pharetra augue nec augue. Nam elit agna endrerit sit amet
                        </p>
                        <span class="solid-text">1990</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6">
            ...
            <div class="row mb-100 order-0 order-lg-1">
               <div class="col-xl-6 col-lg-6">
                  <div class="tp-history-left">
                     <div class="tp-history-thumb">
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="tp-history-right">
                     <div class="tp-history-content space-1">
                        <h4 class="tp-history-title">Base Government</h4>
                        <p>
                           There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised. Suspendisse sollicitudin velit sed leo. Ut pharetra augue nec augue. Nam elit agna endrerit sit amet
                        </p>
                        <span>2010</span>
            ...
            <div class="row mb-100">
               <div class="col-xl-6 col-lg-6">
                  <div class="tp-history-right">
                     <div class="tp-history-content space-2 text-start text-lg-end">
                        <h4 class="tp-history-title">Smart City</h4>
                        <p>
                           There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised. Suspendisse sollicitudin velit sed leo. Ut pharetra augue nec augue. Nam elit agna endrerit sit amet
                        </p>
                        <span class="solid-text">2020</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6">
