...
<body>
   ...
   <main>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 mb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                  <div class="tp-feature-3-item tp-feature-3-bg d-flex justify-content-center align-items-center p-relative" data-background="assets/img/feature/feature-3-1.jpg">
                     <div class="tp-feature-3-content-wrap text-center">
                        ...
                        <h4 class="tp-feature-3-title-sm"><a href="department-details.html">The growth of the richest <br> city of all time</a></h4>
                     </div>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 mb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                  <div class="tp-feature-3-item tp-feature-3-bg d-flex justify-content-center align-items-center p-relative" data-background="assets/img/feature/feature-3-2.jpg">
                     <div class="tp-feature-3-content-wrap text-center">
                        ...
                        <h4 class="tp-feature-3-title-sm"><a href="event-details.html">City highlights include <br> all attraction</a></h4>
                     </div>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 mb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                  <div class="tp-feature-3-item tp-feature-3-bg d-flex justify-content-center align-items-center p-relative" data-background="assets/img/feature/feature-3-3.jpg">
                     <div class="tp-feature-3-content-wrap text-center">
                        ...
                        <h4 class="tp-feature-3-title-sm"><a href="event-details.html">The growth of the richest <br> city of all time</a></h4>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <!-- service area start -->
      <div class="tp-service-3-area pt-120 pb-90 theme-bg-2">
         <div class="container">
      ...
      <!-- service area start -->
      <div class="tp-service-area tp-service-2-mlr pt-110 z-index-2">
         <div class="container">
            <div class="tp-service-2-title-wrap">
               <div class="row align-items-end">
                  ...
                  <div class="col-xl-6">
                     <div class="tp-service-2-btn-box text-end">
      ...
      <!-- brand area start -->
      <div class="tp-brand-area pb-100 pt-100">
         <div class="container">
            <div class="row">
               <div class="col-xl-12">
