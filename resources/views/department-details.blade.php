            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index text-center">
                     <h3 class="breadcrumb__title">Department Details</h3>
                     <div class="breadcrumb__list">
                        <span><a href="index.html">Home</a></span>
                        <span class="dvdr"><i class="fa fa-angle-right"></i></span>
                        <span>DEPERTMENT DETAILS</span>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="dp-top-thumb mb-50">
                     <img src="assets/img/department/departments-1.jpg" alt="">
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-xl-8 col-lg-8">
                  <div class="dp-text-wrap">
                     <div class="dp-text-box">
                        <h4 class="tp-inner-title">Jobs & Unemployment</h4>
                        <p>
                           Lorem ipsum is simply free text used by copytyping refreshing. Neque porro est qui dolorem ipsum quia quaed inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Aelltes port lacus quis enim var sed efficitur turpis gilla sed
                        </p>
                     </div>
                     <b>You must apply for a Business Schengen Visa at the consulate or embassy of the nation into which you will</b>
                     <p class="mb-40">
                        It has survived not only five centuries. Lorem Ipsum is simply dummy text of the new design printng and type setting Ipsum Take a look at our round up of the best shows coming soo has been the is industrys. When an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but alsocontaining.
                     </p>
                     <div class="dp-list-box d-flex align-items-center mb-40">
                        <div class="dp-list-thumb">
                           <img src="assets/img/department/departments-2.jpg" alt="">
                        </div>
                        <div class="dp-list-wrap">
                           <div class="tp-mayor-feature-list">
                              <ul>
                                 <li><i class="fa-sharp fa-light fa-badge-check"></i><span>Power of choice is untrammelled</span></li>
                                 <li><i class="fa-sharp fa-light fa-badge-check"></i><span>Obligations of business it will frequently </span></li>
                                 <li><i class="fa-sharp fa-light fa-badge-check"></i><span>Obligations of business it will frequently </span></li>
                              </ul>
                           </div>
                           <p class="mb-0">Lorem ipsum is simply free text used copytyping refreshing. Neque porro est qui dolorem ipsum quia quaed inventore veritatis et quasi sgher
                              Neque porro est qui dolorem ipsum</p>
                        </div>
                     </div>
                     <div class="dp-text-box">
                        <h4 class="tp-inner-title">Inspiaring the Future</h4>
                        <p>
                           Lorem ipsum is simply free text used by copytyping refreshing. Neque porro est qui dolorem ipsum quia quaed inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Aelltes port lacus quis enim var sed efficitur turpis gilla sed
                        </p>
                     </div>
                     ...
                     <div class="tp-service-details-left-box">
                        <div class="tp-service-details-widget mb-30">
                           <div class="tp-service-details-category">
                              <ul>
                                 <li>
                                    <a class="p-relative" href="#"><span>Parking Permission</span><i class="flaticon-right-arrow"></i></a>
                                 </li>
                                 <li>
                                    <a class="p-relative active" href="#"><span>Birth Certificate</span><i class="flaticon-right-arrow"></i></a>
                                 </li>
                                 <li>
                                    <a class="p-relative" href="#"><span>Driving License</span><i class="flaticon-right-arrow"></i></a>
                                 </li>
                                 <li>
                                    <a class="p-relative" href="#"><span>Bulding Permission</span><i class="flaticon-right-arrow"></i></a>
                                 </li>
                                 <li>
                                    <a class="p-relative" href="#"><span>Tax Return</span><i class="flaticon-right-arrow"></i></a>
                                 </li>
                                 <li>
                                    <a class="p-relative" href="#"><span>Report Pollution</span><i class="flaticon-right-arrow"></i></a>
                                 </li>
                              </ul>
                           </div>
                        </div>
                        <div class="tp-service-details-widget theme-bg-2 mb-30">
                           <div class="tp-service-details-content">
                              <i class="flaticon-buildings"></i>
                              <span>Great City For Develope Your Career</span>
                              <a class="tp-btn-xl" href="contact.html">JOIN NOW</a>
                           </div>
                        </div>
                        <div class="tp-service-details-widget mb-30">
                           <h4 class="tp-service-details-title">Related Downloads</h4>
                           <div class="tp-service-details-download-box mb-20 d-flex align-items-center">
                              ...
                              <div class="tp-service-details-download-info">
                                 <h5><a href="#">Garbage & Recycling</a></h5>
                                 <span>Last update 23, 2023</span>
                              </div>
                           </div>
                           <div class="tp-service-details-download-box mb-20 d-flex align-items-center">
                              <div class="tp-service-details-download-icon">
                              ...
                              <div class="tp-service-details-download-info">
                                 <h5><a href="#">Pay Your Council Tax</a></h5>
                                 <span>Last update 23, 2023</span>
                              </div>
                           </div>
                        </div>
