...
<body>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index text-center">
                     <h3 class="breadcrumb__title">Portfolio Details</h3>
      ...
      <div class="tp-porfolio-details-area project-details-customize pt-120 pb-90">
         <div class="container">
            <div class="row">
               <div class="col-xl-12">
                  <div class="evn-thumb-wrap mb-40 p-relative">
                     <div class="evn-thumb">
                        <img src="assets/img/project/project-details-1.jpg" alt="">
                     </div>
                     <div class="evn-avata-content-wrap z-index">
                        <div class="evn-related-info d-flex justify-content-between align-items-center">
                           <span><b>Date:</b>May 1, 2023</span>
                           <span>
                              <a href="https://www.google.com.bd/maps/@23.7806365,90.4193257,12z"><b>Location:</b>8 Street, USA</a>
                           </span>
                           <span><b>Catagory:</b>Goverments</span>
                           <span>
                              <a href="www.company.com" target="_blank"><b>Website:</b>www.company.com</a>
                           </span>
                        </div>
                     </div>
                  </div>
                  <div class="evn-text-box mb-30">
                     <h4 class="tp-inner-title">Spring Conference</h4>
                  ...
                  <div class="evn-text-box mb-50">
                     <h4 class="tp-inner-title">The challenge of Project</h4>
            ...
            <div class="row justify-content-center">
               <div class="col-xl-8">
                  <div class="tp-team-title-box mb-50 text-center">
                     <span class="tp-section-subtitle-2">Latest events</span>
                     <h4 class="tp-section-title mb-25">Explore More Portfolio</h4>
                  </div>
               </div>
            </div>
            <div class="row">
                              ...
                              <div class="tp-project-2-item p-relative text-center">
                                 ...
                                 <div class="tp-project-2-content d-flex align-items-center justify-content-center">
                                    <div>
                                       ...
                                       <h4 class="tp-project-2-title-sm"><a href="#">Town of Rome</a></h4>
                                    </div>
                                 </div>
                              </div>
                           </div>
      ...
      <div class="tp-contactform-area pb-120">
         <div class="container">
            <div class="row">
               <div class="col-xl-12">
                  <div class="tp-team-details-contact-box grey-bg-2">
                     <h4 class="tp-team-details-title pb-20">Leave a Reply</h4>
                     <form action="#">
