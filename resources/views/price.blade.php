...
<body>
   ...
   <main>
      ...
      <!-- price area start -->
      <div class="tp-price-area pt-120 pb-80">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-xl-6">
                  <div class="tp-price-title-box text-center mb-50">
                     <span class="tp-section-subtitle-2">check our faqs</span>
                     <h4 class="tp-section-title">Flexible Pricing that Scales with Your Business</h4>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-xl-4 col-lg-6 col-md-6 mb-40">
                  <div class="tp-price-item p-relative">
                     <div class="tp-price-content-wrap text-center">
                        <div class="tp-price-icon">
                           <span><i class="flaticon-buildings"></i></span>
                        </div>
                        <div class="tp-price-tag">
                           <span>Basic Package</span>
                        </div>
                        <div class="tp-price-info">
                           <h4>$420<span>/month</span></h4>
                        </div>
                        <div class="tp-price-btn">
                           <a class="tp-btn-grey" href="contact.html">CHOOSE A PLAN</a>
                        </div>
                     </div>
                     <div class="tp-price-list">
                        <ul>
                           <li><i class="flaticon-verify"></i>Mauris nec</li>
                           <li><i class="flaticon-verify"></i>Nunc eu suscip</li>
                           <li><i class="flaticon-verify"></i>Aliquam mauris dol</li>
                           <li><i class="flaticon-verify"></i>Mauris ligula justo, mat</li>
                           <li><i class="flaticon-verify"></i>Suspendisse potenti. Integer</li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-6 col-md-6 mb-40">
                  <div class="tp-price-item active p-relative">
                     <div class="tp-price-content-wrap text-center">
                        <div class="tp-price-icon">
