...
<body>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index text-center">
                     <h3 class="breadcrumb__title">{{ __('messages.Committee') }}</h3>
                     <div class="breadcrumb__list">
                        <span><a href="index.html">{{ __('messages.Home') }}</a></span>
                        <span class="dvdr"><i class="fa fa-angle-right"></i></span>
                        <span>{{ __('messages.Committee') }}</span>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="tp-team-2-area pt-115 pb-90">
         <div class="container">
            <div class="row">
               @foreach($teams as $team) <!-- Loop through each team member -->
               <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div class="tp-team-2-item fix p-relative">
                     <div class="tp-team-2-thumb-box">
                        <img src="{{ asset('uploads/' . $team->cover) }}" alt="Cover Image">
                     </div>
                     <div class="tp-team-2-content text-center">
                        <h4 class="tp-team-2-title">
                           <a href="{{ route('team.details', ['slug' => $team->slug]) }}">
                              {{ app()->getLocale() == 'ar' ? $team->name_ar : $team->name_en }}
                           </a>
                        </h4>
                        <span>{{ app()->getLocale() == 'ar' ? $team->position_ar : $team->position_en }}</span>
                        <!--  Share Links -->
                        <div class="tp-team-2-social-box">
                           <button><i class="fa-solid fa-share-nodes"></i></button>
                           <div class="tp-team-2-social">
                              <a class="icon-1" href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('team.details', ['slug' => $team->slug])) }}" target="_blank">
                                 <i class="fa-brands fa-facebook-f"></i>
                              </a>
                              <a class="icon-2" href="https://wa.me/?text={{ urlencode(route('team.details', ['slug' => $team->slug])) }}" target="_blank">
                                 <i class="fa-brands fa-whatsapp"></i>
                              </a>
                              <a class="icon-4" href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(route('team.details', ['slug' => $team->slug])) }}" target="_blank">
