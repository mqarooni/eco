                  ...
                  <form action="#">
                     <div class="table-content table-responsive">
                        <table class="table">
                           ...
                           <tbody>
                              <tr>
                                 <td class="product-thumbnail"><a href="product-details.html"><img src="assets/img/shop/shop-4.png" alt=""></a></td>
                                 <td class="product-name"><a href="product-details.html">Ancient Tanpura</a>
                                 </td>
                              ...
                              <tr>
                                 <td class="product-thumbnail"><a href="product-details.html"><img src="assets/img/shop/shop-3.png" alt=""></a></td>
                                 <td class="product-name"><a href="product-details.html">Classic Alarm</a>
                                 </td>
                        ...
                        <div class="col-12">
                           <div class="coupon-all">
                              <div class="coupon d-flex align-items-center">
                                 ...
                                 <button class="tp-btn-xl green-anim" name="apply_coupon" type="submit">Apply coupon</button>
                              </div>
                              <div class="coupon2">
                                 <button class="tp-btn-xl green-anim" name="update_cart" type="submit">Update cart</button>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="row justify-content-end">
                        <div class="col-md-5 ">
                           <div class="cart-page-total">
                              ...
                              <a class="tp-btn-xl green-anim text-center w-100" href="checkout.html">Proceed to checkout</a>
                           </div>
                        </div>
                     </div>
                  </form>
