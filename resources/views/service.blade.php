                     ...
                     <div class="tp-service-standard-content-wrap z-index">
                        <div class="tp-service-standard-content-main">
                           <div class="tp-service-standard-content">
                              ...
                              <h4 class="tp-service-standard-title"><a href="service-details.html">Service & <br> Depertments</a></h4>
                           </div>
                     ...
                     <div class="tp-service-standard-content-wrap z-index">
                        <div class="tp-service-standard-content-main">
                           <div class="tp-service-standard-content">
                              ...
                              <h4 class="tp-service-standard-title"><a href="service-details.html">Tourism & <br> Visitor Guide</a></h4>
                           </div>
                           <div class="tp-service-standard-link">
                              <a href="service-details.html">Read More <i class="flaticon-right-arrow"></i></a>
                           </div>
                     ...
                     <div class="tp-service-standard-content-wrap z-index">
                        <div class="tp-service-standard-content-main">
                           <div class="tp-service-standard-content">
                              ...
                              <h4 class="tp-service-standard-title"><a href="service-details.html">History & <br> Establishment</a></h4>
                           </div>
                           <div class="tp-service-standard-link">
                              <a href="service-details.html">Read More <i class="flaticon-right-arrow"></i></a>
                           </div>
                  ...
                  <div class="tp-about-2-right-wrap pl-20">
                     ...
                     <div class="tp-about-2-tel-wrap">
                        ...
                        <div class="tp-about-2-btn-box d-flex align-items-center">
                           <a class="tp-btn-xl mr-60 green-anim" href="about.html">Discover More</a>
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-xl-7 col-lg-7">
                     <div
                        ...
                        <a class="tp-btn-black" href="#">SUBSCRIBE</a>
                     </div>
                  </div>
               </div>
            </div>
