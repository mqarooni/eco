...
<body>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index text-center">
                     <h3 class="breadcrumb__title">{{ __('messages.Sustainable_development_goals') }}</h3>
                     <div class="breadcrumb__list">
                        <span><a href="index.html">{{ __('messages.Home') }}</a></span>
                        <span class="dvdr"><i class="fa fa-angle-right"></i></span>
                        <span>{{ __('messages.Sustainable_development_goals') }}</span>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <!-- sustainable development goals area  -->
      <div class="sustainable-development-goals-area pt-115 pb-90">
         <div class="container">
            <div class="row justify-content-start">
               @foreach ($goals as $goal)
               <div class="col-xl-12 col-lg-10 col-md-12 mb-30">
                  <div class="sustainable-goal-item text-left">
                     <!-- Image -->
                     <div class="icon mb-4">
                        <img src="{{ asset('uploads/' . $goal->image) }}" alt="Icon" class="goal-icon">
                     </div>
                     <!-- Title (Arabic or English based on locale) -->
                     <div class="title mb-3">
                        <h2>{{ app()->getLocale() == 'ar' ? $goal->title_ar : $goal->title_en }}</h2>
                     </div>
                     <!-- Description (Arabic or English based on locale) -->
                     <div class="description">
                        <p>{!! app()->getLocale() == 'ar' ? $goal->description_ar : $goal->description_en !!}</p>
                     </div>
                  </div>
               </div>
               @endforeach
