...
<body>
   ...
   <main>
      ...
      <!-- shop area start -->
      <div class="tp-shop-area pt-120 pb-90">
         <div class="container">
            <div class="tp-product-top-wrap mb-40">
               <div class="row align-items-center">
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                      <div class="tp-shop-text">
                          <span>Showing 12 of 120 results</span>
                      </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                      <div class="tp-shop-filter d-flex justify-content-start justify-content-sm-end">
                          <select>
            ...
            <div class="row">
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     <div class="tp-shop-thumb p-relative">
                        ...
                        <a class="tp-btn-cart" href="cart.html">ADD TO CART</a>
                     </div>
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">King Statue</a></h4>
                        <span>$44</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     ...
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Classic Alarm</a></h4>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     ...
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Ancient Tanpura</a></h4>
                        <span>$685.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     ...
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Black & White TV</a></h4>
                        <span>$225.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     ...
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Wagon Van</a></h4>
                        <span>$925.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     ...
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Coffen of Farao</a></h4>
                        <span>$1262.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     ...
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Ancient Jug</a></h4>
                        <span>$90.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     <div class="tp-shop-thumb p-relative">
                        <img src="assets/img/shop/shop-8.png" alt="">
                        <a class="tp-btn-cart" href="cart.html">ADD TO CART</a>
                        <span class="tp-shop-badge">Sale!</span>
                     </div>
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">History of Egypt</a></h4>
                        <span>$532.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     <div class="tp-shop-thumb p-relative">
                        <img src="assets/img/shop/shop-9.png" alt="">
                        <a class="tp-btn-cart" href="cart.html">ADD TO CART</a>
                     </div>
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Wooden Chair</a></h4>
                        <span>$585.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     <div class="tp-shop-thumb p-relative">
                        <img src="assets/img/shop/shop-10.png" alt="">
                        <a class="tp-btn-cart" href="cart.html">ADD TO CART</a>
                        
                        <span class="tp-shop-badge">Sale!</span>
                     </div>
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Zeep 45 kt</a></h4>
                        <span>$4925.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     <div class="tp-shop-thumb p-relative">
                        <img src="assets/img/shop/shop-11.png" alt="">
                        <a class="tp-btn-cart" href="cart.html">ADD TO CART</a>
                     </div>
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Ancient Camera</a></h4>
                        <span>$1925.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-shop-item text-center">
                     <div class="tp-shop-thumb p-relative">
                        <img src="assets/img/shop/shop-12.png" alt="">
                        <a class="tp-btn-cart" href="cart.html">ADD TO CART</a>
                        <span class="tp-shop-badge">Sale!</span>
                     </div>
                     <div class="tp-shop-content">
                        <h4 class="tp-shop-title"><a href="shop-details.html">Sunduk Case</a></h4>
                        <span><del>$180.00</del> $168.00</span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-12">
                  <div class="basic-pagination mt-50 text-center">
                     <nav>
                        <ul>
                           <li>
