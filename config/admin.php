...
return [
    ...
    */
    'extensions' => [
        'media-manager' => [
            'disk' => 'media'  // Ensure this disk is correctly configured in `config/filesystem.php`
        ],
        'ckeditor' => [
            'enable' => true,
            'config' => [
                ...
                'height' => 500,
                'contentsCss' => [
                    '/assets/css/frontend-body-content.css',  // Assuming this is another CSS you want to include
                    '/assets/css/custom-editor-style.css'    // Your custom style that includes Tajawal
                ]
            ]
        ],
    ],
